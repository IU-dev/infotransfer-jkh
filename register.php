        ...
        <div class="form-group row">
            ...
            <div class="col-8">
                <div class="input-group">
                    ...
                    <input id="username" value="<?php echo $username; ?>" name="username" type="text"
        ...
        <div class="form-group row">
            ...
            <div class="col-8">
                <div class="input-group">
                    ...
                    <input id="displayname" value="<?php echo $displayname; ?>" name="displayname" type="text"
                           class="form-control" required="required">
                </div>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-8">
                <div class="input-group">
                    ...
                    <input id="password-confirm" value="<?php echo $password_confirm; ?>" name="password-confirm"
