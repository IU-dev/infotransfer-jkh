...
<?php if (isset($_SESSION['logged_in'])) : ?>
    ...
    <form class="form-vertical" action="z_counter.php" method="post">
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="col">
                    <input id="bally" name="bally" type="text" placeholder="" class="form-control input-md" required=""
                           value="<?php echo $bally; ?>"/>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col">
                    <button value="submit-search" id="submit" name="submit-addpoints" class="btn btn-success">Выполнить
                        запрос
                    </button>
                </div>
            </div>
    ...
    <?php
    $counters = $db->select_desc_fs('counters', "client_id = '" . $user->id . "'");
